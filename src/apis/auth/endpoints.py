...
docs = {
    ...
    'refresh_access_token': '<p>Gets a new access token to be used as an authorization header value for all '
                            'other endpoints.</p>'
}


@auth_endpoints.route('/create_tokens', doc={"description": docs['get_tokens']})
...
@auth_endpoints.route('/refresh_access_token', doc={"description": docs['refresh_access_token']})
